...
```
E:\pgsql16\00\timescaledb\src\compat\compat.h(63,1): error C1189: #error:  "Unsupported PostgreSQL version" [E:\pgsql16\00\timescaledb\build\tsl\src\timescaledb-tsl.vcxproj]
```
...
- Common error after CREATE EXTENSION:
  ```
  ERROR:  could not load library "<some-path>/timescaledb-x.xx.x.dll": The specified procedure could not be found.
  ```
...
### Limitation
- Currently I only provide a TimescaleDB package for PostgreSQL v16.1, because that is what I needed for my project and what I tested on Windows 11 (25H2).
